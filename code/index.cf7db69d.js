 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const Zo=new class{handleAttributeExpressions(e,t,r,n){const o=t[0];return o==="."?new Ko(e,t.slice(1),r).parts:o==="@"?[new Jo(e,t.slice(1),n.eventContext)]:o==="?"?[new Wo(e,t.slice(1),r)]:new ln(e,t,r).parts}handleTextExpression(e){return new jt(e)}};/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 * http://polymer.github.io/LICENSE.txt
...
`,be=class extends Et{constructor(){super(...arguments);this.localize=new kn(this)}render(){return Pe`
    ...
    `}};be.styles=Vi;be=v([Oe("sl-spinner")],be);const zi=Ht`@media(min-width: 1000px) {
        sl-card {
          max-width: 70vw;
        }
      }
    ...
    `]}async firstUpdated(){console.log("This is my home page, yay!"),console.table([["X connected","Channels: X"],["Pseudo: X","Phrase: XXXXXXX"],["Debug:","true"]])}share(){navigator.share&&navigator.share({title:"Bridges - Secure chat",text:"Build secure bridges with your friends!",url:"https://hadrienboyer.github.io/bridges-chat-pwa"})}render(){return mt`
    ...
    `}};Ne([Se({type:String})],Dt.prototype,"title",2);Ne([Se({type:Boolean})],Dt.prototype,"enableBack",2);Dt=Ne([we("app-header")],Dt);var Xi=Object.defineProperty,Ji=Object.getOwnPropertyDescriptor,Gi=(e,t,r,n)=>{for(var o=n>1?void 0:n?Ji(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Xi(t,r,o),o};let Dr=class extends V{static get styles(){return Ht`
      main {
        padding-left: 16px;
        padding-right: 16px;
        padding-bottom: 16px;
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/bridges-chat-pwa/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vn(()=>import("./app-about.2986fb5f.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
          <div id="routerOutlet"></div>
        </main>
      </div>
    `}};Dr=Gi([we("app-index")],Dr);export{zi as a,we as e,Ht as i,V as s,mt as y};
//# sourceMappingURL=index.cf7db69d.js.map
