...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Tn=(e,t,r,n)=>{for(var o=n>1?void 0:n?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Fi(t,r,o),o};let _e=class extends V{constructor(){super();this.message="Welcome, anonymous!"}static get styles(){return[zi,Ht`
      #welcomeBar {
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    `]}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"Bridges - Secure chat",text:"Chat repository:",url:"https://github.com/omiklo/bridges"})}render(){return mt`
    ...
    `}};Tn([Se()],_e.prototype,"message",2);_e=Tn([we("app-home")],_e);var qi=Object.defineProperty,Ki=Object.getOwnPropertyDescriptor,Ne=(e,t,r,n)=>{for(var o=n>1?void 0:n?Ki(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&qi(t,r,o),o};let Dt=class extends V{constructor(){super();this.title="BRIDGES",this.enableBack=!1}static get styles(){return Ht`
      header {
        display: flex;
        justify-content: space-between;
        align-items: center;
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/bridges-chat-pwa/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vn(()=>import("./app-about.26d5d0eb.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
...
//# sourceMappingURL=index.91db9859.js.map
